...
export default function App() {
  ...
  const displayNFTData = ({ tokenId, transactionId, ipfsLink }) => {
    return (
      <div class=" d-flex align-items-start text-white bg-dark shadow p-3 mb-5 bg-dark rounded-lg" style={{ border: "solid" }}>
        <div> {`token ID: ${tokenId}`}</div>
        <div>
          <a href={`https://goerli-optimism.etherscan.io/tx/${transactionId}`}>
            Link to explorer
          </a>
        </div>
        <div>
  ...
  return (
    ...
    <Nav />
      <header>
        <h3>Play the OpticalFlip card game</h3>
        <h3>To mint NFT's</h3>
        <div>
      ...
      <footer>
        <p class = "text-center fst-italic">powered by Optimism Blockchain</p>
        <div className="score">
          <div className="moves">
